...
{
    public static class TempAlgorithmTool
    {
        #region 메서드
        ...
        public static double GetMeanSampledLevel(FindAreaParam distanceParam, ImageBuffer image, int rowStartIndex, int rowEndIndex, int horizontalOffset)
        {
        ...
        public static double GetMeanSampledLevel(FindAreaParam distanceParam, ImageBuffer image, int columnStartIndex, int verticalOffset)
        {
            byte[] imageData = image.ImageData;
            int imageWidth = image.ImageWidth;
