        ...
        public void CheckCoatingArea_Line(ImageBuffer imageBuffer, List<SurfaceInfo> coatingInfoList, SurfaceParam surfaceParam, SurfaceInspResult surfaceInspResult, bool isTapeInsp)
        {
            ...
            foreach (SurfaceInfo coatingInfo in coatingInfoList)
            {
                ...
                if (isTapeInsp == true)
                {
                    ...
                    {
                        surfaceParam.TapeParam.ConnectionTapeLevel = 20;
                ...
                {
                    surfaceParam.LineParam.LineLevel = 50;
                    //surfaceParam.LineParam.LineSizeX = 0.5;

                    surfaceParam.LineParam.LineSizeX = 0.04;
                    surfaceParam.LineParam.LineSizeY = 4.9;
